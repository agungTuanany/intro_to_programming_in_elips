...
#+LATEX_HEADER: \lstset{language=[auto]lisp,frame=tb, basicstyle=\small\sfffamily,numbers=left,numberstyle=\tiny,frame=tb,tabsize=4,columns=fixed,showstringspaces=false,showtabs=false,keepspaces,commentstyle=\color{gray}, keywordstyle=\color{red}}
