...
#+LATEX_HEADER: \lstset{language=[auto]lisp,frame=tb, basicstyle=\scriptsize\sfffamily,numbers=left,numberstyle=\tiny,frame=tb, linewidth=8cm, aboveskip=1em, tabsize=4,columns=fixed,showstringspaces=false,showtabs=false,keepspaces,commentstyle=\color{gray}, keywordstyle=\color{red}}
...
%paragraph
#+LATEX_HEADER: \titlespacing\paragraph{0pt}{5pt}{-4pt} % left margin, space before subsection header, space after subsection header

%subparagraph
#+LATEX_HEADER: \titlespacing\subparagraph{0pt}{5pt}{-6pt} % left margin, space before subsection header, space after subsection header
