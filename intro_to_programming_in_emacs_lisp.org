...
- Our next object is to count the number of words in a function
  ...
  ~count-words-example~.  See [[Counting via Repetition Regexps]]. If we
...
- However, I am more ambitious: I want to count the words ans symbols
  ...
  - [[][Several defun]]                         Counting several defuns in a file

  - [[][Find a File]]                           Do you want to look at a file?

  - [[][length-list-file]]                      A list of the length of many definitions

  - [[][Several length]]                        Counting in definitions in different files
